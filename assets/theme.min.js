...
window.eshop = window.eshop || {}, eshop.themeControls = eshop.themeControls || {};
...
! function (e) {
    ...
    var i = n(3),
        a = (n(6), function () {
            function e(t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                _classCallCheck(this, e), this.element = t, this.delegateElement = new domDelegate.Delegate(this.element), this.delegateBody = new domDelegate.Delegate(document.body), this.onOpen = n.onOpen || function () {}, this.onClose = n.onClose || function () {}, this.isOpen = !1, this.direction = this.element.classList.contains("Drawer--fromLeft") ? "fromLeft" : "fromRight", this.pageOverlayElement = document.querySelector(".PageOverlay"), this._attachListeners(), eshop.themeControls.filterdrawer = this
            }
            return _createClass(e, [{
                key: "destroy",
                value: function () {
                ...
                value: function (e) {
                    function t(e) {
                        ...
                        for (i = 0, o = e.elements.length; i < o; i++)
                            if ("" !== (r = e.elements[i]).name && !r.disabled) switch (r.nodeName.toLowerCase()) {
                                case "input":
                                    switch (r.type) {
                                        case "text":
                                        case "hidden":
    ...
    var i = function () {
        ...
        return _createClass(e, [{
            ...
            value: function () {
                var e = this;
                fastdom.measure(function () {
                    var t, n = e.element.getBoundingClientRect().top + window.scrollY - e.element.offsetTop + e.initialTopOffset,
    ...
    var i = n(8),
        ...
        c = function () {
            function e(t) {
                ...
                })), "sidebar" === this.settings.filterPosition, this.element.querySelector(".PageHeader__ImageWrapper") && window.matchMedia("(-moz-touch-enabled: 0), (hover: hover)").matches && (this.parallaxInstance = new Rellax(".PageHeader__ImageWrapper", {
                    speed: -7,
                    center: !1,
                    round: !0
            ...
            return _createClass(e, [{
                key: "onUnload",
                value: function () {
                    this.delegateElement.off("click"), this.sortPopover && this.sortPopover.destroy(), this.filterDrawer && this.filterDrawer.destroy(), this.parallaxInstance && this.parallaxInstance.destroy(), window.theme.showElementStaggering && (this.intersectionObserver.disconnect(), this.timeline.kill())
                }
            }, {
                key: "_setupAnimation",
                value: function () {
                ...
                key: "_sortByChanged",
                value: function (e) {
                    this.currentSortBy !== e && (this.currentSortBy = e, eshop.Collection_filtering.currentSortBy = e, eshop.Collection_filtering.getCollectionJSON())
                }
            }, {
                key: "_toggleTag",
                value: function (e) {
                ...
                value: function () {
                    ...
                    s.default.nodeListToArray(this.element.querySelectorAll(".CollectionFilters [data-tag]")).forEach(function (t) {
                        eshop.Collection_filtering.currentFilters.map(x => x.tag).includes(t.getAttribute("data-tag")) ? (t.classList.add("is-active"), t.parentNode.classList.add("is-selected")) : (t.classList.remove("is-active"), t.parentNode.classList.remove("is-selected"))
                    })
                }
            }, {
                key: "_commit",
            ...
            return _createClass(e, [{
                ...
                value: function (e) {
                    var t = e ? e.detail.currentBreakpoint : u.ResponsiveHelper.getCurrentBreakpoint(),
                        n;
                    if (t !== (e ? e.detail.previousBreakpoint : null))
                        if ("phone" === t || "tablet" === t) this.carouselNavScrollSpy = new r.default(this.element, this.slideshowImages, {
                            rootMargin: "-" + this.slideshowNavDots.firstElementChild.offsetTop + "px 0px 0px 0px"
                        }), this.productInfoScroller && this.productInfoScroller.destroy(), this.productThumbnailsScroller && this.productThumbnailsScroller.destroy(), this.productAsideElement ? this.productAsideElement.style.minHeight = null : this.productWrapperElement.style.minHeight = null, this.productInfoElement.parentNode.style.maxHeight = null;
                        else {
        ...
        s = function () {
            function e(t) {
                _classCallCheck(this, e), this.element = t, this.delegateElement = new domDelegate.Delegate(this.element), this.slideshow = new i.default(this.element.querySelector("[data-flickity-config]"), {
                    ...
                    delay: window.theme.showPageTransition ? .5 : 0
                }), this._transitionToSlide(this.slideshow.flickityInstance.selectedCell.element, !0), this._attachListeners(),this.players = [],this._init_videos()
            }
            return _createClass(e, [{
                key: "onUnload",
                value: function () {
                    this.slideshow.destroy(), this.timeline.kill(), this.delegateElement.off(),
                    this.player.destroy(), document.removeEventListener("breakpoint:changed", this._onBreakpointChangedListener)
                }
            }, {
                key: "onBlockSelect",
                value: function (e) {
                ...
                value: function(){
                  ...
                  t.querySelectorAll("[data-video-settings]").forEach(function(element, index){
                    var options = JSON.parse(element.getAttribute("data-video-settings"));
                    if(options){
                      e._loadScript(options).then(e._setupPlayer.bind(e, element, options, index));
                    }
                  })
                }
            }, {
                ...
                value: function (options) {
                    ...
                    return new Promise(function (t, n) {
                        var i = document.createElement("script");
                        document.body.appendChild(i), i.onload = t, i.onerror = n, i.async = !0, i.src = "youtube" === options.videoType ? "//www.youtube.com/iframe_api" : "//player.vimeo.com/api/player.js"
                    })
                }
            }, {
                key: "_setupPlayer",
                value: function (element, options, index) {
                    var e = this, t = element.querySelector(".ImageHero__VideoHolder");
                    setTimeout(function () {
                        "youtube" === options.videoType ? e.players.push(new YT.Player(t, {
                            ...
                            events: {
                                onReady: e._onYouTubeReady.bind(e, index),
                                onStateChange: e._onYouTubeStateChange.bind(e, index)
                            }
                        })) : e.players.push(new Vimeo.Player(t.parentNode, {
                            id: options.videoId,
                            autoplay: !0,
                            muted: !0,
                            background: !0,
                ...
                value: function (e, index) {
                    this.players[e].mute(), this.players[e].playVideo()
                }
            }, {
                key: "_onYouTubeStateChange",
                value: function (e, index) {
                    this.data === YT.PlayerState.ENDED && this.players[e].playVideo()
                }
            }, {
                key: "_pauseSlideshow",
                value: function () {
                    ...
                    if (!n.classList.contains("is-selected")) {
                        ...
                        fastdom.measure(function () {
                            ...
                            if (a = n < e) {
                                var i = t.offsetLeft,
                                    r, l, c = null,
                                    u = (c = i <= n - (i + t.offsetWidth) ? t.previousElementSibling || t : t.nextElementSibling || t).offsetLeft - o.scrollLeft,
                                    d = u + c.offsetWidth;
                                d > n ? s = d - n : u < 0 && (s = u)
                            }
                        }), fastdom.mutate(function () {
